...
from HCL_Geo.trainer import train_fig
from HCL_Geo.evaluate.cvusa_and_cvact import evaluate, calc_sim
from HCL_Geo.loss import InfoNCE
from HCL_Geo.model import  TimmModel
...
if __name__ == '__main__':
    ...
    model_path = "{}/teacher".format(args.model_path)
